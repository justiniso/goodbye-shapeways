...
/*
     FILE ARCHIVED ON 4:09:01 Mar 30, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 1:50:28 Jun 27, 2015.
...
(function ($) {
  ...
  $.swPortal.loadGooglePlus = function () {
    ...
    (function () {
      ...
      po.async = true;
      po.src = '/web/20140330040901/https://apis.google.com/js/plusone.js';
 ...
 * /web/20140330040901/http://dev.twitter.com/pages/intents-events#click
...
function cancelLoginSignUp(elem) {
  var fancyBoxWrap = $(elem).parents('.fancybox-wrap');
  if (fancyBoxWrap.length > 0) {
    (fancyBoxWrap).find('.close-button').click();
  }
  else {
    history.go(-1);
  }
