...
/*
     FILE ARCHIVED ON 1:04:25 Sep 9, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 1:35:39 Jun 27, 2015.
...
(function ($) {
  ...
  $.swPortal.loadGooglePlus = function () {
    ...
    (function () {
      ...
      po.async = true;
      po.src = '/web/20120909010425/https://apis.google.com/js/plusone.js';
  ...
  SW.track = function (eventName, data) {
    ...
    data['requestTrackingId'] = $("#requestTrackingId").val();
    $.ajax({
      type:'POST',
      url:'/api/track',
      data:data
 ...
 * /web/20120909010425/http://dev.twitter.com/pages/intents-events#click
...
(function () {
  ...
  ga.async = true;
  ga.src = ('https:' == document.location.protocol ? '/web/20120909010425/https://ssl' : '/web/20120909010425/http://www') + '.google-analytics.com/ga.js';
  var s = document.getElementsByTagName('script')[0];
