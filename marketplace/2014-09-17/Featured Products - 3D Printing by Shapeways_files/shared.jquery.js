...
/*
     FILE ARCHIVED ON 14:25:22 Sep 14, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 2:12:57 Jun 27, 2015.
...
(function ($) {
  ...
  $.swPortal.loadGooglePlus = function () {
    ...
    (function () {
      ...
      po.async = true;
      po.src = '/web/20140914142522/https://apis.google.com/js/plusone.js';
...
(function () {
  ...
  po.type = 'text/javascript';
  po.async = true;
  po.src = '/web/20140914142522/https://plus.google.com/js/client:plusone.js?onload=start';
  var s = document.getElementsByTagName('script')[0];
  s.parentNode.insertBefore(po, s);
})();
 ...
 * /web/20140914142522/http://dev.twitter.com/pages/intents-events#click
...
function googleSignInClick(elem) {
  ...
  var options = {
    ...
    'clientid' : appId,
    'scope' : '/web/20140914142522/https://www.googleapis.com/auth/plus.login /web/20140914142522/https://www.googleapis.com/auth/userinfo.email',
