...
(function ($) {
  ...
  $.swPortal.loadGooglePlus = function () {
    ...
    (function () {
      ...
      po.async = true;
      po.src = '/web/20130913195351/https://apis.google.com/js/plusone.js';
  ...
  $.swPortal.productBoxClick = function (event) {
    ...
    if (
      ...
      if ($productUrl.length) {
        console.log($(this).closest('.product-box'));
        if (jQuery(event).attr('ctrlKey') || $(this).closest('.product-box').hasClass('new-tab')) {
 ...
 * /web/20130913195351/http://dev.twitter.com/pages/intents-events#click
...
function showDialogText(text, title, modal, width, className, minHeight) {
